...
if ($client['created_by'] == $_SESSION['user_id']) {
    if (isset($_POST['company_id'])) {
        ...
        $sql = "UPDATE clients SET company_name=:company_name, contact_person=:contact_person, phone=:phone, address=:address, created_at=:created_at, edited_at=:edited_at WHERE company_id=:company_id";
